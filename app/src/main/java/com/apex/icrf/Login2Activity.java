...
//        getSupportActionBar().setTitle("");
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Login2Activity.this, RegistrationActivity.class));
            }
        });
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        if (response.length() == 0) {
                            Toast.makeText(Login2Activity.this, "Invalid Credentials", Toast.LENGTH_LONG).show();
                        } else {
...
//                        else
//                            startActivity(new Intent(Login2Activity.this, OTPActivity.class));
                        ...
                        startActivity(new Intent(Login2Activity.this, OTPActivity.class).putExtra("login_bundle", login_bundle));
    ...
    private void submitRequest() {
        ...
        if (mobile.length() == 0) {
            Toast.makeText(Login2Activity.this, "Mobile number cannot be empty", Toast.LENGTH_LONG).show();
        } else {
            ...
            if (current_country.equalsIgnoreCase("IN")) {
                ...
                if (mobile.length() == 10) {
                    ...
                    Toast.makeText(Login2Activity.this, "Please enter a valid Mobile number", Toast.LENGTH_LONG).show();
                }
            } else {
    ...
    private void parseArrayResponse(JSONObject response) {
        ...
        try {
            ...
            Toast.makeText(Login2Activity.this, status, Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            e.printStackTrace();
